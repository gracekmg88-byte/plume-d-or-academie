      ...
      <Layout>
        <div className="container py-12 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            {!isOnline
              ? "Cette publication n'a pas été consultée en ligne auparavant et n'est pas disponible hors connexion."
      ...
      <div className="container py-8 md:py-12">
        ...
        {!isOnline && (
          <div className="flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 text-amber-700 dark:text-amber-400 rounded-lg px-4 py-2 mb-6 text-sm">
            ...
            <span>Mode hors ligne — Lecture depuis le cache local</span>
          </div>
        )}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{format(new Date(displayPub.created_at), "d MMMM yyyy", { locale: fr })}</span>
              </div>
              <div className="flex items-center gap-2">
                <Eye className="h-4 w-4" />
                <span>{displayPub.views_count} consultations</span>
              </div>
            </div>
